...
ensemble members for a set historical period
...
Usage
-----
    [1] read_LENShistorical(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns)
"""

def read_LENShistorical(directory,vari,sliceperiod,sliceshape,slicenan,numOfEns):
    """
    ...
    Usage
    -----
    read_LENShistorical(directory,vari,sliceperiod,sliceshape,
                             slicenan,numOfEns)
    """
    print('\n>>>>>>>>>> STARTING read_LENShistorical function!')
    ...
    print('>>>>>>>>>> ENDING read_LENShistorical function!')    
...
# ravelbinary = True
# lensalso = True
# lat,lon,var = read_LENShistorical(directory,vari,
