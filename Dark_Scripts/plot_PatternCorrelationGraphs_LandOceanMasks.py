...
#       for mo in range(1):
        ...
        for ii in range(len(yrALLr)):
            ...
            plt.title(r'\textbf{PATTERN CORRELATIONS FOR [ %s ] OF %s}' % (variables[vv],typemask),color='k',fontsize=15)
...
###############################################################################   
        ...
        if option == 8:
            ...
            plt.title(r'\textbf{PATTERN CORRELATIONS PER YEAR - %s}' % typemask,color='k',fontsize=15)
