...
lrp = np.load(directorydata + 'LRPcomposites_Arctic_7classes.npy',allow_pickle=True)
lrpAA = np.load(directorydata + 'LRPcomposites_ArcticAA_7classes.npy',allow_pickle=True)
...
for r in range(alldata.shape[0]):
    ...
    if r == 13:
        ...
        cbar.set_label(label,fontsize=7,color='darkgrey',labelpad=6.5)      
        ...
        cbar.set_label(labeld,fontsize=7,color='darkgrey',labelpad=6.5)    
...
ax1.annotate(r'\textbf{Difference}',xy=(0,0),xytext=(-6.9,0.5),
              textcoords='axes fraction',color='w',fontsize=10,
              rotation=90,ha='center',va='center')    
ax1.annotate(r'\textbf{1950-2004}',xy=(0,0),xytext=(-6.9,1.61),
              textcoords='axes fraction',color='w',fontsize=10,
              rotation=90,ha='center',va='center')
ax1.annotate(r'\textbf{2005-2019}',xy=(0,0),xytext=(-6.9,2.6),
              textcoords='axes fraction',color='w',fontsize=10,
              rotation=90,ha='center',va='center')
...
if scaleLRPmax == True:
    plt.savefig(directoryfigure + 'MSFigure-5_v6_scaleLRP_DARK.png',dpi=1000)
else:
    plt.savefig(directoryfigure + 'MSFigure-5_v6_DARK.png',dpi=1000)