...
plt.savefig(directoryfigure + 'TimeSeries_MeanGlobalTemperature_SMILE_DARK.png',
            dpi=300)
...
plt.savefig(directoryfigure + 'TimeSeries_MeanGlobalTemperatureAnomalies_SMILE_DARK.png',
            dpi=600)