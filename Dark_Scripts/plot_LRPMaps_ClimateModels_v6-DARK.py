...
for va in range(len(variablesall)):
    for m in range(len(pickSMILEall)):
        ...
        #     np.save(directorydataMS + 'LRPcomposites_SMILEglobe_7classes.npy',lrptest)
        # elif typeOfAnalysis == 'Experiment-4':
        #     np.save(directorydataMS + 'LRPcomposites_SMILEglobe_7classes_GLO.npy',lrptest)
        ...
        plt.scatter(x,obspred,c=obspred,s=40,clip_on=False,cmap=cm.cubehelix2_16.mpl_colormap,
