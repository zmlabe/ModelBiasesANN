...
for va in range(len(variablesall)):
    for m in range(len(pickSMILEall)):
        ...
        plt.savefig(directoryfigure + '%s/Regions/LRPCompositesOBSERVATIONS_%s.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/Regions/ActualOBSERVATIONS_%s.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/Regions/ActualOBSERVATIONS_dt_%s.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/Regions/ActualOBSERVATIONS_glo_%s.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/Regions/ActualOBSERVATIONS_z_%s.png' % (typeOfAnalysis,saveData),dpi=300)