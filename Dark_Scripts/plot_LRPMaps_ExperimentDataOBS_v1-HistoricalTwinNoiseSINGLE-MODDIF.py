...
for va in range(len(variablesall)):
    for m in range(len(pickSMILEall)):
        ...
        plt.savefig(directoryfigure + '%s_LRPCompositesOBSERVATIONS_%s.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s_ActualOBSERVATIONS_%s.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s_ActualOBSERVATIONS_dt_%s.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s_ActualOBSERVATIONS_glo_%s.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s_ActualOBSERVATIONS_z_%s.png' % (typeOfAnalysis,saveData),dpi=300)