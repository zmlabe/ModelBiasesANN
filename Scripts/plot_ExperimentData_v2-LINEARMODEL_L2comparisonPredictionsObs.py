...
for va in range(len(variablesall)):
    for m in range(len(pickSMILEall)):
        ...
        for ww in range(len(ridge_penalty)):
            ...
            if land_only == True:
                saveDatao = timeper + '_LAND' + '_LINEAR_MODDIF4_' + typeOfAnalysis + '_' + variq + '_' + reg_name + '_' + dataset_obs + '_' + 'NumOfSMILE-' + str(num_of_class) + '_Method-' + ensTypeExperi
                typemask = 'LAND'
            elif ocean_only == True:
                saveDatao = timeper + '_OCEAN' + '_LINEAR_MODDIF4_' + typeOfAnalysis + '_' + variq + '_' + reg_name + '_' + dataset_obs + '_' + 'NumOfSMILE-' + str(num_of_class) + '_Method-' + ensTypeExperi
                typemask = 'OCEAN'
            else:
                saveDatao = timeper + '_LINEAR_MODDIF4_' + typeOfAnalysis + '_' + variq + '_' + reg_name + '_' + dataset_obs + '_' + 'NumOfSMILE-' + str(num_of_class) + '_Method-' + ensTypeExperi
                typemask = 'GLOBAL'
