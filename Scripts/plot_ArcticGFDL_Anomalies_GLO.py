...
for vv in range(1):
    for mo in range(1):
        ...
        directoryfigure = '/Users/zlabe/Desktop/ModelComparison_v1/Climatologies/Arctic/GLO/Anomalies'
        ...
        models,obs = dSS.remove_annual_mean(modelsq,obsq,lats,lons,lats_obs,lons_obs)
...
###############################################################################     
        if variq == 'T2M':
            ...
            barlim = np.round(np.arange(-20,21,5),2)
            cmap = cmocean.cm.balance
            label = r'\textbf{[T2M-GLOcomposite: $^{\circ}$C]}'
...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_GLObiasobs_%s.png' % pickmodelname,dpi=300)
...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_GLOdiffmm_%s.png' % pickmodelname,dpi=300)
...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_GLObiasmm_%s.png' % pickmodelname,dpi=300)