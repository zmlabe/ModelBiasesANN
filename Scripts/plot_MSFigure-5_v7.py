...
ax1.annotate(r'\textbf{1950-2003}',xy=(0,0),xytext=(-6.9,1.61),
              textcoords='axes fraction',color='k',fontsize=10,
              rotation=90,ha='center',va='center')
ax1.annotate(r'\textbf{2004-2019}',xy=(0,0),xytext=(-6.9,2.6),
              textcoords='axes fraction',color='k',fontsize=10,
              rotation=90,ha='center',va='center')
...
if scaleLRPmax == True:
    plt.savefig(directoryfigure + 'MSFigure-5_v7_scaleLRP.png',dpi=1000)
else:
    plt.savefig(directoryfigure + 'MSFigure-5_v7.png',dpi=1000)