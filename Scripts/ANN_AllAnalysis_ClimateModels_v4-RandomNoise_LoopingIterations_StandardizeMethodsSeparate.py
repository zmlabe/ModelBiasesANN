...
directoryoutput = '/Users/zlabe/Documents/Research/ModelComparison/Data/Loop_SEP/'
###############################################################################
###############################################################################
...
if land_only == True:
    saveData = str(SAMPLEQ) + '_' + timeper + '_' + seasons[0] + '_LAND' + '_StandMethodsSEP_' + typeOfAnalysis + '_' + variq + '_' + reg_name + '_' + dataset_obs + '_' + 'NumOfSMILE-' + str(num_of_class) + '_Method-' + ensTypeExperi
elif ocean_only == True:
    saveData = str(SAMPLEQ) + '_' + timeper + '_' + seasons[0] + '_OCEAN' + '_StandMethodsSEP_' + typeOfAnalysis + '_' + variq + '_' + reg_name + '_' + dataset_obs + '_' + 'NumOfSMILE-' + str(num_of_class) + '_Method-' + ensTypeExperi
else:
    saveData = str(SAMPLEQ) + '_' + timeper + '_' + seasons[0] + '_StandMethodsSEP_' + typeOfAnalysis + '_' + variq + '_' + reg_name + '_' + dataset_obs + '_' + 'NumOfSMILE-' + str(num_of_class) + '_Method-' + ensTypeExperi
...
np.savez(directoryoutput + 'networkseed_' + saveData + '.npz',net)
np.savez(directoryoutput + 'segmentseed_' + saveData + '.npz',seg)      
np.savez(directoryoutput + 'obsout_' + saveData + '.npz',obsconf)  
