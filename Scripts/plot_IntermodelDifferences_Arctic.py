"""
Script for exploring intermodel differences in the Arctic
...
###############################################################################     
        ...
        if AA == 'now':
            plt.savefig(directoryfigure + 'Arctic_InterModel_AA.png',dpi=300)
        else:
            plt.savefig(directoryfigure + 'Arctic_InterModel.png',dpi=300)