...
lrp = np.load(directorydata + 'LRPcomposites_ArcticALL_7classes_%s-NEG.npy' % dataset_obs,allow_pickle=True)
...
if scaleLRPmax == True:
    plt.savefig(directoryfigure + 'MSFigure-2_v7_scaleLRP-negrel.png',dpi=1000)
else:
    plt.savefig(directoryfigure + 'MSFigure-2_v7-negrel.png',dpi=1000)