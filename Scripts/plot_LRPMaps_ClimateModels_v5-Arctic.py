    ...
    for m in range(len(pickSMILEall)):
        ...
        if typeOfAnalysis == 'Experiment-3':
            if AA == False:
                ...
                np.save(directorydataMS + 'LRPcomposites_Arctic_8classes.npy',lrptest)
                np.save(directorydataMS + 'Lat_Arctic.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_Arctic.npy',np.asarray(lon1))
            elif AA == True:
                directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v5/'
                np.save(directorydataMS + 'LRPcomposites_ArcticAA_8classes.npy',lrptest)
                np.save(directorydataMS + 'Lat_Arctic.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_Arctic.npy',np.asarray(lon1))
        elif typeOfAnalysis == 'Experiment-4':
            if AA == False:
                directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v5/'
                np.save(directorydataMS + 'LRPcomposites_Arctic_8classes_GLO.npy',lrptest)
                np.save(directorydataMS + 'Lat_Arctic.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_Arctic.npy',np.asarray(lon1))
            elif AA == True:
                directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v5/'
                np.save(directorydataMS + 'LRPcomposites_ArcticAA_8classes_GLO.npy',lrptest)
                np.save(directorydataMS + 'Lat_Arctic.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_Arctic.npy',np.asarray(lon1))
