...
if typeOfAnalysis == 'Experiment-3':
    ...
    np.savez(directorydataMS + 'CountingIterations_%s_GLO.npz' % ('SMILEGlobe'),mpi=countingmpi[0,:],lens=countinglens[0,:])
    np.savez(directorydataMS + 'CountingIterations_%s_GLO.npz' % ('Arctic'),gfdl=countinggfdl[1,:],mpi=countingmpi[1,:])
sys.exit()   
###############################################################################
###############################################################################
###############################################################################
