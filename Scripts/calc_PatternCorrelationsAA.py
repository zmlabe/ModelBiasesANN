"""
Script for calculating pattern correlations between models and observations in
the Arctic for two different time periods
...
###############################################################################        
        ...
        if slicetimeperiod == 'allyears':
            ...
            np.savez(directorydata + saveData + '_corrs_%s60.npz' % slicetimeperiod,corr)
            np.savez(directorydata + saveData + '_corrsdt_%s60.npz' % slicetimeperiod,corrdt)
            np.savez(directorydata + saveData + '_corrsglo_%s60.npz' % slicetimeperiod,corrglo)
            np.savez(directorydata + saveData + '_corrstrends_%s60.npz' % slicetimeperiod,corrtrends)