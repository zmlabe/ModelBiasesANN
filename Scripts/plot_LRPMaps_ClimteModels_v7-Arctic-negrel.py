    ...
    for m in range(len(pickSMILEall)):
        ...
        if typeOfAnalysis == 'Experiment-3':
            if AA == False:
                ...
                np.save(directorydataMS + 'LRPcomposites_Arctic_7classes_%s-NEG.npy' % dataset_obs,lrptest)
                np.save(directorydataMS + 'Lat_Arctic.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_Arctic.npy',np.asarray(lon1))
            elif AA == True:
                directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v7/'
                np.save(directorydataMS + 'LRPcomposites_ArcticAA_7classes_%s-NEG.npy' % dataset_obs,lrptest)
                np.save(directorydataMS + 'Lat_Arctic.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_Arctic.npy',np.asarray(lon1))
            elif AA == 'none':
                directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v7/'
                np.save(directorydataMS + 'LRPcomposites_ArcticALL_7classes_%s-NEG.npy' % dataset_obs,lrptest)
            ...
            if AA == False:
                directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v7/'
                np.save(directorydataMS + 'LRPcomposites_Arctic_7classes_GLO_%s-NEG.npy' % dataset_obs,lrptest)
                np.save(directorydataMS + 'Lat_Arctic.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_Arctic.npy',np.asarray(lon1))
            elif AA == True:
                directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v7/'
                np.save(directorydataMS + 'LRPcomposites_ArcticAA_7classes_GLO_%s-NEG.npy' % dataset_obs,lrptest)
                np.save(directorydataMS + 'Lat_Arctic.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_Arctic.npy',np.asarray(lon1))
            elif AA == 'none':
                directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v7/'
                np.save(directorydataMS + 'LRPcomposites_ArcticALL_7classes_GLO_%s-NEG.npy' % dataset_obs,lrptest)
                np.save(directorydataMS + 'Lat_ArcticALL.npy',np.asarray(lat1))
                np.save(directorydataMS + 'Lon_ArcticALL.npy',np.asarray(lon1))
        ...
        plt.tight_layout()
        if AA == True:
            plt.savefig(directoryfigure + '%s/ObservationsData_%s_AA-NEG.png' % (typeOfAnalysis,saveData),dpi=300)
        else:
            plt.savefig(directoryfigure + '%s/ObservationsData_%s-NEG.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.tight_layout()
        if AA == True:
            plt.savefig(directoryfigure + '%s/PredictedModels_%s_AA-NEG.png' % (typeOfAnalysis,saveData),dpi=300)
        else:
            plt.savefig(directoryfigure + '%s/PredictedModels_%s-NEG.png' % (typeOfAnalysis,saveData),dpi=300)