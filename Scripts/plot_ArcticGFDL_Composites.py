...
select variables over the 1950 to 2019 period after removing the annual mean
...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_Bias_%s_GLO.png' % pickmodelname,dpi=300)
...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_Spread_%s_GLO.png' % pickmodelname,dpi=300)
...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_STD_%s_GLO.png' % pickmodelname,dpi=300)