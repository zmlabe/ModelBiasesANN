...
def readData(window,typemodel,variq,simuqq,land_only,reg_name,rm_standard_dev):
    ...
    data = Dataset(directorydata + 'LRP_Maps_ABS_ModelBiases-STDDEV%syrs_%s_Annual_%s_%s_land_only-%s_%s_STD-%s_%s_ClimateChange_rm_annual_mean-%s_Anomalies-%s_anom.nc' % (window,typemodel,variq,simuqq,land_only,reg_name,rm_standard_dev,ensTypeExperi,rm_annual_mean,calculate_anomalies))
...
trainindices = np.int_(np.genfromtxt(directorydata + 'trainingEnsIndices_ABS_ModelBiases_%s_%s_%s_%s_iterations%s_STD-%s_%s_ClimateChange_rm_annual_mean-%s_Anomalies-%s_anom.txt' % (variq,monthlychoice,reg_name,dataset,iterations[0],rm_standard_dev,ensTypeExperi,rm_annual_mean,calculate_anomalies)))
testindices = np.int_(np.genfromtxt(directorydata + 'testingEnsIndices_ABS_ModelBiases_%s_%s_%s_%s_iterations%s_STD-%s_%s_ClimateChange_rm_annual_mean-%s_Anomalies-%s_anom.txt' % (variq,monthlychoice,reg_name,dataset,iterations[0],rm_standard_dev,ensTypeExperi,rm_annual_mean,calculate_anomalies)))
classel = np.int_(np.genfromtxt(directorydata + 'allClasses_ABS_ModelBiases_%s_%s_%s_%s-%s_iterations%s_STD-%s_%s_ClimateChange_rm_annual_mean-%s_Anomalies-%s_anom.txt' % (variq,monthlychoice,reg_name,dataset_obs,dataset,iterations[0],rm_standard_dev,ensTypeExperi,rm_annual_mean,calculate_anomalies)))
