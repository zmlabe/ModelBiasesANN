...
for va in range(len(variablesall)):
    for m in range(len(pickSMILEall)):
        ...
        if typeOfAnalysis == 'Experiment-3':
            ...
            np.save(directorydataMS + 'LRPobs_ArcticALL_7classes_%s-NEG.npy' % dataset_obs,lrpobs)
            np.save(directorydataMS + 'LRPobs_OBSCALED_ArcticALL_7classes_%s-NEG.npy' % dataset_obs,dataanomsobstestz_testing)
            np.save(directorydataMS + 'Lat_ArcticALL.npy',np.asarray(lat1))
            np.save(directorydataMS + 'Lon_ArcticALL.npy',np.asarray(lon1))
            np.save(directorydataMS + 'Labels_LRPObs_%s-NEG.npy' % dataset_obs,obs_test)
        elif typeOfAnalysis == 'Experiment-4':
            directorydataMS = '/Users/zlabe/Documents/Research/ModelComparison/Data/RevisitResults_v7/'
            np.save(directorydataMS + 'LRPobs_ArcticALL_7classes_GLO_%s-NEG.npy' % dataset_obs,lrpobs)
            np.save(directorydataMS + 'LRPobs_OBSCALED_7classes_GLO_%s-NEG.npy' % dataset_obs,dataanomsobstestz_testing)
            np.save(directorydataMS + 'Lat_ArcticALL.npy',np.asarray(lat1))
            np.save(directorydataMS + 'Lon_ArcticALL.npy',np.asarray(lon1))
            np.save(directorydataMS + 'Labels_LRPObs_%s_GLO-NEG.npy' % dataset_obs,obs_test)
        ...
        plt.savefig(directoryfigure + '%s/LRPCompositesOBSERVATIONS_%s_negrel.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/ActualOBSERVATIONS_%s_negrel.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/ActualOBSERVATIONS_dt_%s_negrel.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/ActualOBSERVATIONS_glo_%s_negrel.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/ActualOBSERVATIONS_z_%s_negrel.png' % (typeOfAnalysis,saveData),dpi=300)
        
        ###############################################################################
        ###############################################################################
        ###############################################################################
        ### Plot subplot of observations (obs minus MMmean differences)
        if variq == 'T2M':
            limit = np.arange(-3,3.01,0.01)
            barlim = np.round(np.arange(-3,4,1),2)
            cmap = cmocean.cm.balance
            label = r'\textbf{OBSmm - [T2M : $^{\circ}$C]}'
        elif variq == 'P':
            limit = np.arange(-3,3.01,0.01)
            barlim = np.round(np.arange(-3,4,1),2)
            cmap = cmocean.cm.tarn
            label = r'\textbf{OBSmm - [P : mm/day]}'
        elif variq == 'P':
            limit = np.arange(-3,3.01,0.01)
            barlim = np.round(np.arange(-3,4,1),2)
            cmap = cmocean.cm.diff
            label = r'\textbf{OBSmm - [SLP : hPa]}'
        ...
        rawdata = np.load(directorydata + 'MMMeandifferences_7models.npy',allow_pickle=True)[:,-14:,:]
        
        fig = plt.figure(figsize=(10,2))
        for r in range(lenOfPicks):
            var = rawdata[r] - dataanomsobstest[r]
        ...
        plt.savefig(directoryfigure + '%s/ActualOBSERVATIONS_diffMMmean_%s_negrel.png' % (typeOfAnalysis,saveData),dpi=300)
        ...
        plt.savefig(directoryfigure + '%s/ActualOBSERVATIONS_z-training_%s_negrel.png' % (typeOfAnalysis,saveData),dpi=300)
