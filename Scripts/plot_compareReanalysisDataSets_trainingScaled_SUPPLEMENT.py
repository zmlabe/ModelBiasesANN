...
stdTraininge = np.genfromtxt('/Users/zlabe/Documents/Research/ModelComparison/Data/TRAININGstandardstd_historical_annual_NoiseTwinSingleMODDIF4_Experiment-3_T2M_Arctic_ERA5BE_NumOfSMILE-7_Method-ENS.txt',
                             unpack=True).reshape(lats_obs.shape[0],lons_obs.shape[0])
...
for v in range(len(composites)):
    ...
    cbar.set_label(r'\textbf{T2M-Scaled}',fontsize=10,color='k')   
...
plt.savefig(directoryfigure + 'ERA5BE_ScaledEpochs.png',dpi=300)
