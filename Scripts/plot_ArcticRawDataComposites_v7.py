...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_BiasAAperiod.png',dpi=300)
...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_SpreadAAperiod.png',dpi=300)
...
###############################################################################     
        ...
        plt.savefig(directoryfigure + 'Arctic_STDAAperiod.png',dpi=300)