...
plt.plot(yearsall,glens,linewidth=1.5,color='k',alpha=1,zorder=3,clip_on=False,label=r'\textbf{LENS}',
...
plt.text(1948,104,r'\textbf{[b]}',color='dimgrey',
         fontsize=7,ha='center')  
plt.text(2024,50,r'\textbf{GLOBAL}',color='dimgrey',fontsize=20,rotation=270,
         ha='center',va='center')
...
x=np.arange(1950,2019+1,1)
plt.plot(yearsall,ampi,linewidth=2,color='k',alpha=1,zorder=3,clip_on=False,label=r'\textbf{MPI}')
...
leg = plt.legend(shadow=False,fontsize=9,loc='upper center',
              ...
              handlelength=5,handletextpad=1)
plt.ylabel(r'\textbf{Frequency of Label}',color='k',fontsize=7) 
plt.text(2024,50,r'\textbf{ARCTIC}',color='dimgrey',fontsize=20,rotation=270,
         ha='center',va='center')          
        
plt.tight_layout()
plt.subplots_adjust(hspace=0.4)
plt.savefig(directoryfigure + 'MSFigure-4.png',dpi=1000)